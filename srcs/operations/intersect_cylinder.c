...
/*   Updated: 2021/01/31 17:12:25 by lcouto           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			intersect_caps(t_cylinder *cylinder, t_ray ray, t_intersec *head)
{
	double			min;
	double			max;
...
t_intersec *head)
{
	...
	invert = invert_matrix(cylinder->transform); // maybe invert when sphere its created
