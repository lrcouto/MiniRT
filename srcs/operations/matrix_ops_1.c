...
/*   Updated: 2020/09/26 21:17:200 by gsenra-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Don't forget to break up this function because of the Norme.
*/
...
t_tuple	mult_matrix_tuple(t_matrix m1, t_tuple t1)
{
	...
	i = 0;
	current = ft_calloc(4, sizeof(double));
	new = ft_calloc(4, sizeof(double));
	current[0] = t1.x;
	current[1] = t1.y;
	current[2] = t1.z;
	current[3] = t1.w;
